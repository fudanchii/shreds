            ...
            return {
                define: function(pathName, eventName, exitEventName) {
                    ...
                    var occurence = pathName.match(/:/g) || [],
                        pattern = new RegExp('^' + pathName.replace(/\//g, "\\/").replace(/:(\w*)/g,"([^\\/\\?]*)") + '$'),
                        route = {
                            eventName: eventName,
                ...
                dispatch: function(route, context) {
                    ...
                    options.logger.info('Dispatching', route.path, 'with', context, 'to', route.eventName);
                    ...
                    for ( i in routes ) {
                        ...
                        if ( params ) {
                            ...
                            if ( current_route ) {
                                ...
                                //-- Don't dispatch the path we are already on
